<template>
  <div class="father">
    ...
    <iframe ref="myIframe" :src="baseUrl + '/#/scene/postMessage/son'" frameborder="0"></iframe>
    <!-- <iframe ref="myIframe" :src="baseUrl + '/#/scene/postMessage/grandson'" frameborder="0"></iframe> -->
  </div>
</template>
